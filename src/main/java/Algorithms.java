...
public class Algorithms {
    ...
    // using main function for testing all functions
    public static void main(String args[])
    {
        String review = "I bought this for my husband who plays the piano. " +
        ...
        System.out.println(noPriority(review));
        System.out.println(firstAndLastSentence(review));
        System.out.println(firstSentenceOnly(review));
        System.out.println(maxSentenceSplit(review));
        System.out.println(maxSentence(review));
        System.out.println(middleOnly(review));
        System.out.println(splitFirstLastAndMiddle(review));
